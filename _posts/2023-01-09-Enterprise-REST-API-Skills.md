---
title: "5 Skills to look for when hiring .NET Core Developer for your Enterprise REST API Project"
date: 2023-01-09
image: /assets/images/5 Skills to look for while hiring .NET Core Developer for your Enterprise REST API Project.png
header:
teaser:
thumbnail:
og_image: /assets/images/5 Skills to look for while hiring .NET Core Developer for your Enterprise REST API Project.png
categories:
- Outsourcing
tags:
- Outsourcing
...
## 4. Documentation 🗄
Understanding of Open API and automated documentation like Swagger will help create documentation that will reduce huge amount of friction between back-end and front-end teams.
