---
title: "Why .NET Core is a popular choice for SaaS Development?"
date: 2023-01-26
image: /assets/images/Why .NET Core is a popular choice for SaaS Development.png
header:
teaser:
thumbnail:
og_image: /assets/images/Why .NET Core is a popular choice for SaaS Development.png
categories:
- SaaS
tags:
- SaaS
...
See: [How cross-platform is .NET really in practice?](https://www.reddit.com/r/csharp/comments/bcji5i/how_crossplatform_is_net_really_in_practice/)
...
See: [How fast is ASP.NET Core?](https://dusted.codes/how-fast-is-really-aspnet-core)
...
See: [.NET is Open Source on Github](https://dotnet.microsoft.com/en-us/platform/open-source)
